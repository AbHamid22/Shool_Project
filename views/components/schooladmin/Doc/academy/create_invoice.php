...
<div class="invoice p-3 mb-3">
  ...
  <div class="row">
    <div class="col-12">
      ...
      <h2 class="float-right">Date: <?php echo date("d M Y") ?></h2>
    </div>
    <!-- /.col -->
  </div>
  <!-- info row -->
  <div class="row invoice-info">
    ...
    <div class="col-sm-4 invoice-col">
      ...
      <address>
        <?php
        echo AcademyStudent::html_select("cmbAcademyStudent");
        ?>
        <div id="AcademyStudent-info"></div>
      </address>
      <!-- <div>
                Shipping Address:<br>
    ...
    <div class="col-sm-4 invoice-col">
      ...
      <table>
        ...
        <tr>
          ...
          <td><input type="text" id="txtIssueDate" value=<?php echo date("d-m-Y"); ?> /></td>
        </tr>
        <tr>
          <td><b>Due Date:</b></td>
...
<script>
  $(function() {
    ...
    let base_url = `http://localhost/My_School_Project/School_Management_Project/api`;
    ...
    $("#btnProcessOrder").on("click", function() {
      ...
      if (confirm("Are you sure?")) {
        ...
        let academy_student_id = $("#cmbAcademyStudent").val();
        let issue_date = $("#txtIssueDate").val();
        let due_date = $("#txtDueDate").val();

        let total = $("#net-total").text();
    ...
    $("#cmbAcademyStudent").on("change", function() {
      $.ajax({
        url: `${base_url}/AcademyStudent/find`,
        type: 'GET',
        data: {
          "id": $(this).val()
        },
        success: function(res) {
          ...
          let academystudent = data.academystudent;

          $("#AcademyStudent-info").html(academystudent.contact_no + "<br>" + academystudent.address);
        }
      });
    ...
    function printCart() {
      ...
      if (invoices != null) {
        ...
        invoices.forEach(function(item, i) {
