...
$invoice = $arg["invoice"];
$student = $arg["academystudent"];
$invoice_details = $arg["details"];
?>
        ...
        <div class="invoice p-3 mb-3" id="print-area">
          ...
          <div class="row">
            ...
            <h4>
              ...
              class="navbar-brand rounded-circle rounded-logo" height="65" />
                ...
                <br>
            <h5 class="float-right">Date: <?= $invoice->issue_date; ?></h5>
              </h4>
            </div>
          </div>
          ...
          <div class="row invoice-info">
            ...
            <table>
                <!-- <tr>
                  <td><b>Order ID:</b></td>
                  <td><input type="text" style="width:60px" value="<?php echo $invoice->id; ?>" readonly /></td>
                </tr> -->
                <tr>
                  <td><b>Issue Date:</b></td>
                  <td><input type="text" id="txtOrderDate" value=<?php echo $invoice->issue_date; ?> /></td>
                </tr>
                <tr>
                  <td><b>Due Date:</b></td>
                  <td><input type="text" id="txtDueDate" value=<?php echo $invoice->due_date; ?> /></td>
                </tr>
              </table>
            </div>
          </div>
            ...
            <div class="col-12 table-responsive">
              <table class="table table-striped">
                ...
                <tbody>
                  ...
                  $i = 1;
                  $sub_total = 0;
                  foreach ($invoice_details as $line) {
