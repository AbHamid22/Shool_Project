...
<div class="receipt-container">
  ...
  <div class="receipt-details">
    <table>
      ...
      <tr>
        <td><strong>Received From:</strong> <?= AcademyStudent::html_select("student_id") ?></td>
  ...
  <table class="items-table">
    <thead>
      ...
      <tr>
        ...
        <th></th>
        <th><input type="button" value=" Add " style="width:100%" name="btnAdd" id="btnAdd" /></th>
      </tr>
    </thead>
    <tbody id="tbody">
    </tbody>
  </table>
  <input type="button" class="btn btn-primary" onclick="CreateMr()" name="btnProcess" value="Save Money Receipt" />
  <div class="total">
 ...
 let base_url = `http://localhost/My_School_Project/School_Management_Project/api`;
  ...
  async function CreateMr() {
    ...
    if (confirm("Are you sure?")) {
      ...
      let academy_student_id = document.querySelector("#student_id").value;
